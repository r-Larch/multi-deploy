...
echo "  2) Create an app:   app create <name>"
echo "  3) Configure it in: $INSTALL_DIR/apps/<name>/"
echo "  4) Manual deploy:   app deploy <name>"
echo "  5) Enable deploys:  app timers <name> on"
echo "  x) Remove app:      app remove <name>"
