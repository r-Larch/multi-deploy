...
main() {
  ...
  # Paths: meta under $INSTALL_DIR/<name>, repo under $INSTALL_DIR/projects/<name>
  local meta_dir="$INSTALL_DIR/$name"
  ...
  # Write project.env into meta dir
...
EOF
  ...
  # Write compose.server.yml override into meta dir
  local bt=$'`'
